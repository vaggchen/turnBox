<template>
  <div class="relative flex flex-col w-full h-full lg:(w-750px h-800px border border-gray-500/50) ">
    <div class="flex-1 p-4 py-8">
      <!-- 游戏内容组件 -->
      <GameCnt v-if="!pass" @stepChange="stepChange" @gamePass="gamePass" ref="gameCnt" />
      <!-- 游戏通过组件 -->
      <GamePass v-else />
    </div>
    <!-- 游戏工具栏组件 -->
